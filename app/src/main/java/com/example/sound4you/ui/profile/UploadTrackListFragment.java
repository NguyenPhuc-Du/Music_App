...
public class UploadTrackListFragment extends Fragment implements TrackView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // request MainActivity to hide bottom navigation (safer than manipulating the view directly)
    ...
    @Override
    public void onTracksLoaded(java.util.List<Track> tracks) {
        ...
        adapter.setOnDeleteConfirmed(track -> {
            if (isSelf) trackPresenter.deleteTrackById(track.getId());
        });
